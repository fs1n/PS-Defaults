@{
    ...
    Description = 'A PowerShell module that standardizes repeating script functions for IT environments, including logging, error handling, webhooks, and common utilities.'
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            Tags = @('IT', 'Standard', 'Logging', 'Error-Handling', 'Webhook', 'Utilities')
            ...
            ReleaseNotes = 'Initial release of PS-Defaults module with standardized IT functions.'
